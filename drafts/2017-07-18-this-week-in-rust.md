...
* Bitfury Group [releases](https://github.com/exonum/exonum/releases) [Exonum](https://exonum.com) — an extensible framework for blockchain projects [written in Rust](https://github.com/exonum/exonum).
