...
<!-- * [ - ]() -->
* [ENTITY Protocol 1.0 - independently implement the sealed protocol in Rust (hard)](https://github.com/blackmore-technology-group/ENTITY-Protocol-1.0-Conformance-Kit/issues/3)
