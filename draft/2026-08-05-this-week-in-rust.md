...
* [vairedb 0.1.0](https://github.com/matteobovetti/vairedb/releases/tag/v0.1.0) - VaireDB v0.1.0 is out — our first release! VaireDB is a cloud native, high performance distributed analytical database: PostgreSQL wire compatibility + DuckDB's vectorized engine for analytics at scale. Hash sharding, quorum writes, column pseudonymization.
