...
- [Rust Automod VSCode Extension](https://marketplace.visualstudio.com/items?itemName=drkryz.rustautomod) — Automates creation and management of `mod.rs` files in Rust projects.
