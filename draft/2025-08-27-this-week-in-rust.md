...
* [greptimedb - Add date and timestamp format to COPY TO (CSV, JSON)](https://github.com/GreptimeTeam/greptimedb/issues/6287)
* [greptimedb - Add compression options to COPY TO](https://github.com/GreptimeTeam/greptimedb/issues/6286)
