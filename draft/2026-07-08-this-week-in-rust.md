...
* [k8s-scale-app-rs: Small Rust CLI that either scales a Kubernetes Deployment to a fixed replica count or triggers a rolling restart on it, via the Kubernetes API](https://blog.none.at/blog/2026/2026-07-06-k8s-scale-app-rs/)
